    ...
    children: [
      {
        href: "/demo/home-centered",
        label: "Home Centered",
        description: "Default centered hero",
        icon: "LayoutTemplate",
        localize: false,
      },
      {
        href: "/demo/home-split",
        label: "Home Split",
        description: "Split-screen hero with orbit visual",
        icon: "Columns2",
        localize: false,
      },
      {
        href: "/demo/home-cinematic",
        label: "Home Cinematic",
        description: "Full-bleed cinematic hero",
        icon: "Film",
        localize: false,
      },
      {
        href: "/demo/home-terminal",
        label: "Home Terminal",
        description: "Mission-readout hero with stats",
        icon: "Terminal",
        localize: false,
      },
    ],
