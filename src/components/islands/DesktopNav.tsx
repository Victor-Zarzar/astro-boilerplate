            ...
            >
              {link.children ? (
                <button
                  ...
                  aria-haspopup="menu"
                  aria-controls={
                    hoveredIndex === index ? `dropdown-${index}` : undefined
                  }
                  onClick={() =>
                    setHoveredIndex(hoveredIndex === index ? null : index)
                  }
