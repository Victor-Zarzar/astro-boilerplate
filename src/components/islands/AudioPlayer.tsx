            ...
            <div className="flex justify-between items-start mb-4 text-zinc-400 border-b border-zinc-800 pb-2">
              ...
              <div className="text-right flex flex-col items-end">
                <div className="flex gap-1 mb-1">
                  <div
                    className={`w-1 h-1 bg-zinc-600 ${isPlaying ? "bg-amber-500 animate-pulse" : ""}`}
                  />
                  <div
                    className={`w-1 h-1 bg-zinc-600 ${isPlaying ? "bg-amber-500 animate-pulse delay-75" : ""}`}
                  />
                  <div
                    className={`w-1 h-1 bg-zinc-600 ${isPlaying ? "bg-amber-500 animate-pulse delay-150" : ""}`}
                  />
                </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 overflow-hidden">
                <div className="flex justify-between items-baseline mb-1">
                  <div className="text-white font-bold truncate max-w-[150px] md:max-w-xs">
                    {title}
                  </div>
                ...
                <div className="relative h-6 flex items-end gap-[2px] bg-zinc-900 border-t border-zinc-800 pt-1">
                  {Array.from({ length: 50 }).map((_, i) => (
                    <motion.div
                      ...
                      style={{
                        backgroundColor:
                          i / 50 > progress / (duration || 1)
                            ? "#3f3f46"
                            : "#f59e0b", // zinc-700 vs amber-500
              ...
              >
                <div
                  className={`w-1 h-3 rounded-sm ${isMuted ? "bg-zinc-700" : "bg-amber-500"}`}
                />
                {isMuted ? (
